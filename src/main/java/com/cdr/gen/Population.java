...
public class Population {
    ...
    public Population(Map<String, Object> config) {
        ...
        //////////////////////////
        //these basically adds configuration into memory.
    ...
    public void create() {
        ...
        for (int i=0; i<size; i+=2) {
            ...
            personOne.setAge(getRandomAge());
            personTwo.setAge(getRandomAge());
            
            personOne.setGender(getGender());
            personTwo.setGender(getGender());
            
            personOne.setStatus(getRandomStatus());
            personTwo.setStatus(getRandomStatus());
            
            personOne.setGeo(getRandomGeoLatitude());
            personTwo.setGeo(getRandomGeoLatitude());
    ...
    protected Double getRandomAge() {
        RandomGaussian age = getRandomGaussian(40, 50);
        return age.getValueOne();
    }
    
    protected Double getGender() {
    	Random rand = new Random();
    	Double value =  Math.floor(1.4*rand.nextDouble());
    	return value;
    	
    }
    
    protected Double getRandomStatus() {
    	Random rand = new Random();
    	Double value =  Math.floor(1.4*rand.nextDouble());
    	return value;
